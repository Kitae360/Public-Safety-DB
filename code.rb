...
class Database
	def initialize()
		...
		@db.execute "CREATE TABLE IF NOT EXISTS Car_Owner_DMV(Owner_Name_F TEXT,
		Owner_Name_M TEXT,
		Owner_Name_L TEXT,
		Registration_num INTEGER,
		PRIMARY KEY (Registration_num))"
		@db.execute "CREATE TABLE IF NOT EXISTS Car_Owner_SCHOOL(Owner_Name_F TEXT,
		Owner_Name_M TEXT,
		Owner_Name_L TEXT,
		...
		@db.execute "CREATE TABLE IF NOT EXISTS Car(Model TEXT,
		Color TEXT,
		Year_of_car INTEGER,
		License_Plate TEXT,
		owner_d_num INTEGER,
		...
		@db.execute "CREATE TABLE IF NOT EXISTS Ticket(Ticket_num INTEGER,
		Reason TEXT,
		Due_date DATE,
		Price INTEGER,
		From_who TEXT,
	...
	def select_suspension()
		puts @db.execute "SELECT Permit_num, LP_CAR FROM Parking_permit WHERE Suspension = 'true'"
	end
